...
<body>
    <header class="d-flex flex-column">
        ...
        <nav class="ps-3 pe-3 mb-3">
            <ul>
                <li><a href="index.php">Introduzione</a></li>
                <li>Norme sulla privacy</li>
                <li>Termini di servizio</li>
                <li>Tecnologie</li>
                <li><a class="active" href="domande_frequenti.php">Domande Frequenti</a></li>
            </ul>
        </nav>
    </header>
    <main>
        <?php
        foreach ($domandeFrequenti as $domandaFrequente) {
            echo "<h2>{$domandaFrequente['domanda']}</h2>";
            echo "<p>{$domandaFrequente['risposta']}</p>";
        }
        ?>
    </main>
</body>
